...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IDEASPACE_CALLER", () => {
    process.env["IDEASPACE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IDEASPACE_CALLER", () => {
    process.env["IDEASPACE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IDEASPACE_CALLER", () => {
    process.env["IDEASPACE_CALLER"] = "unknown"
