export const dict = {
  ...
  "mcp.type.local": "Local",
  "mcp.type.remote": "Remote",
  "mcp.add.title": "Add MCP server",
  "mcp.add.success": "Added {{name}}",
  "mcp.edit.title": "Edit MCP server",
  "mcp.edit.success": "Saved {{name}}",
  "mcp.connect.success": "Connected {{name}}",
  "mcp.disconnect.success": "Disconnected {{name}}",
  "mcp.auth.success": "Authenticated {{name}}",
  "mcp.delete.title": "Delete MCP server",
  "mcp.delete.confirm": 'Delete MCP server "{{name}}"?',
  "mcp.delete.button": "Delete MCP server",
  "mcp.delete.success": "Removed {{name}}",
  "mcp.field.name.label": "Name",
  "mcp.field.name.placeholder": "my-server",
  "mcp.field.type.label": "Connection type",
  "mcp.field.enabled.label": "Enabled",
  "mcp.field.command.label": "Command",
  "mcp.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path/to/project",
  "mcp.field.env.label": "Environment variables",
  "mcp.field.env.key.placeholder": "KEY",
  "mcp.field.env.value.placeholder": "value",
  "mcp.field.env.remove": "Remove environment variable",
  "mcp.field.env.add": "Add environment variable",
  "mcp.field.url.label": "Server URL",
  "mcp.field.url.placeholder": "https://example.com/mcp",
  "mcp.field.oauth.label": "Use OAuth",
  "mcp.field.clientId.label": "Client ID",
  "mcp.field.clientId.placeholder": "client-id",
  "mcp.field.clientSecret.label": "Client secret",
  "mcp.field.clientSecret.placeholder": "client-secret",
  "mcp.field.headers.label": "Headers",
  "mcp.field.headers.key.placeholder": "Header-Name",
  "mcp.field.headers.value.placeholder": "value",
  "mcp.field.headers.remove": "Remove header",
  "mcp.field.headers.add": "Add header",
  "mcp.error.name.required": "Name is required",
  "mcp.error.name.exists": "That MCP server already exists",
  "mcp.error.command.required": "Command is required",
  "mcp.error.url.required": "Server URL is required",
  "mcp.error.url.invalid": "Enter a valid URL",
  ...
  "settings.images.description": "Choose which model to use for generated images.",
  "settings.images.search.placeholder": "Search image models",
  "settings.images.empty.filter": "No image models match your search",
  "settings.images.empty.noProviders": "Connect Google or Google Vertex first",
  ...
  "settings.mcp.connected.of": "of",
  "settings.mcp.connected.label": "connected",
  "settings.mcp.empty.title": "No MCP servers yet",
  "settings.mcp.empty.description": "Add a local or remote MCP server to make its tools available.",
  "settings.mcp.tag.global": "global",
  "settings.mcp.tag.unknown": "Unknown",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Manage agent skills and capabilities.",
  "settings.skills.origin.managed": "managed",
  "settings.skills.origin.external": "external",
  "settings.skills.origin.cache": "cache",
  "settings.skills.section.managed": "Managed Skills",
  "settings.skills.section.inherited": "Inherited Skills",
  "settings.skills.managed.empty": "No managed skills found.",
  "settings.skills.inherited.empty": "No inherited skills found.",
  "settings.skills.import.title": "Import Skill",
  "settings.skills.import.selectDir": "Select skill directory",
  "settings.skills.import.selectFile": "Select SKILL.md file",
  "settings.skills.import.chooseDir": "Choose Directory",
  "settings.skills.import.chooseFile": "Choose File",
  "settings.skills.import.success": "Skill imported successfully",
  "settings.skills.remove.success": "Skill {{name}} removed",
  ...
  "settings.permissions.tool.kanban_read.title": "Kanban Read",
  "settings.permissions.tool.kanban_read.description": "Read project kanban cards from .ideaspace/kanban.json",
  "settings.permissions.tool.kanban_create.title": "Kanban Create",
  "settings.permissions.tool.kanban_create.description": "Create project kanban cards in .ideaspace/kanban.json",
  "settings.permissions.tool.kanban_update.title": "Kanban Update",
  "settings.permissions.tool.kanban_update.description": "Update project kanban cards in .ideaspace/kanban.json",
