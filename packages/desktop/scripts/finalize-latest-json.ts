...
const releaseId = process.env.IDEASPACE_RELEASE
if (!releaseId) throw new Error("IDEASPACE_RELEASE is required")

const version = process.env.IDEASPACE_VERSION
if (!releaseId) throw new Error("IDEASPACE_VERSION is required")
