    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/AndreDalwin/Ideaspace#readme"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/AndreDalwin/Ideaspace/issues"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/AndreDalwin/Ideaspace/issues/new/choose"),
