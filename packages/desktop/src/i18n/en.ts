export const dict = {
  ...
  "desktop.menu.help.documentation": "Ideaspace Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Ideaspace",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Ideaspace has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'ideaspace' command.",
  ...
  "desktop.cli.error.sidecarMissing": "Ideaspace CLI binary is missing. Try reinstalling the desktop app.",
